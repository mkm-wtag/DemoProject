...
public class UserServiceImpl implements UserService {
    ...
    @Override
    @Transactional
    public ResponseObject updateUser(String userId, EditUser editUser, HttpSession session) {
        if (!AuthorizationUtility.isCustomerLoggedIn(session)) {
            throw new CustomerLoginException("You are not logged in.");
        }
        ...
        oldUser.setUserName(editUser.getNewName());
        oldUser.setUserPassword(editUser.getNewPassword());
        userDAO.update(oldUser);
        return new ResponseObject("password has been changed successfully.");
    }
    ...
    @Override
    @Transactional
    public ResponseObject getLoggedIn(Login login, HttpSession session) {
